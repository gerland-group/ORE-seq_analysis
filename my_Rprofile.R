...
# installing bioconductor packages (R version >= 3.6)
...
# installing bioconductor packages (older R version <= 3.4)
...
color_palette <- c("#e31a1c", "#253494", "#fecc5c", "#56B4E9", "#888888", "#fd8d3c", "#000000", "#CC79A7")
...
if(grepl("restriction_enzyme", getwd())) {
  source("../RE_functions.R")
} else if(grepl("bisulfite", getwd())) {
  source("../BS_functions.R")
} else if(grepl("mnase", getwd())) {
} else if(grepl("comparisons", getwd())) {
}
